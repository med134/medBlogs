...
const NavBarDashboard = () => {
  return (
    <header className="relative w-full flex items-center justify-evenly bg-white px-4 py-4 shadow sm:flex-row md:h-20">
      <div className="flex w-full justify-end items-end overflow-hidden transition-all sm:max-h-full sm:flex-row sm:items-center">

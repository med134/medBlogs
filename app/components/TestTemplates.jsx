      ...
      <div class="w-full bg-gray-50">
        <div class="mx-auto max-w-screen-xl px-2 py-10">
          <div class="mt-4 w-full">
            <div class="flex w-full items-center justify-stretch space-y-2 sm:flex-row sm:space-y-0">
              ...
              <button
                type="button"
                class="relative mr-auto inline-flex text-left cursor-pointer items-center rounded-full border border-gray-200 bg-white px-5 py-2 text-sm font-medium text-gray-800 hover:bg-gray-100 focus:shadow sm:mr-0"
              >
              ...
              <tbody class="bg-white lg:border-gray-300">
                <tr class="">
                  <td class="whitespace-no-wrap py-4 text-left text-sm text-gray-600 sm:px-3 lg:text-left">
                    07 February, 2022
                    <div class="mt-1 flex text-xs font-medium lg:hidden"></div>
                  </td>
                  ...
                  <td class="whitespace-no-wrap  py-4 text-left text-sm text-gray-600 sm:px-3 lg:table-cell lg:text-left">
                    Jane Doeson
                  </td>
                  <td class="whitespace-no-wrap  py-4 text-left text-sm text-gray-600 sm:px-3 lg:table-cell lg:text-left">
                    24 x 10 x 5 cm
                  ...
                  <td class="whitespace-no-wrap flex justify-center items-center py-5 text-right text-sm text-gray-600 sm:px-3 lg:text-left">
                    $59.00
                    <span class="mt-1 ml-auto flex w-fit whitespace-nowrap rounded-full bg-purple-100 px-2 py-0.5 text-center text-xs text-purple-800 lg:hidden">
                      Action Required
                    </span>
                  </td>
                </tr>

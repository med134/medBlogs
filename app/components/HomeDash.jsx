...
const HomeDash = () => {
  return (
    <div className="grid grid-cols-4 py-10 sm:grid-cols-2 gap-6 w-full">
      <div className="flex col-span-1 flex-col px-2 py-2 bg-white shadow rounded-lg overflow-hidden">
      ...
      <div className="flex flex-col px-2 col-span-1 py-2 bg-white shadow rounded-lg overflow-hidden">
        <div className="flex flex-col items-center space-y-2">
      ...
      <div className="flex flex-col px-2 py-2 col-span-1 bg-white shadow rounded-lg overflow-hidden">
        <div className="flex flex-col items-center space-y-2">

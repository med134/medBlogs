export default function HeroLoading() {
  return (
    <div
      className="flex justify-between items-start space-y-8 p-6 animate-pulse md:space-y-0 md:space-x-8 md:flex md:flex-wrap-reverse xs-space-x-0 xs:p-2 xs:mt-2"
    >
      ...
      <div className="flex items-center justify-center xs:p-0 p-6 w-full h-56 bg-gray-300 rounded dark:bg-gray-700">
        <svg
